...
export function getEmailResetEmailTemplate(userEmail) {
    return [
        ...
        '----------------------',
        '',
        `Your email address for grommunio-chat has been changed to ${userEmail}.`,
...
export function getJoinEmailTemplate(sender, userEmail, team, isGuest = false) {
    ...
    return [
        ...
        `${isGuest ? 'You were invited as a guest to collaborate with the team' : 'Start collaborating with your team on grommunio-chat'}`,
        '',
        ...
        '',
        'What is grommunio-chat?',
        'grommunio-chat is a flexible, open source messaging platform that enables secure team collaboration.',
...
export function getMentionEmailTemplate(sender, message, postId, siteName, teamName, channelDisplayName) {
    ...
    return [
        ...
        '',
        `Reply in grommunio-chat ( ${baseUrl}/landing#/${teamName}/pl/${postId} )`,
        '',
        `@${sender}`,
...
export function getEmailVerifyEmailTemplate(userEmail) {
    ...
    return [
        ...
        '',
        'This email address was used to create an account with grommunio-chat.',
