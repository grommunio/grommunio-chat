...
type S3FileBackend struct {
	...
	isCloud        bool // field to indicate whether this is running under grommunio-chat cloud or not.
}
...
// NewS3FileBackend returns an instance of an S3FileBackend and determine if we are in grommunio-chat cloud or not.
