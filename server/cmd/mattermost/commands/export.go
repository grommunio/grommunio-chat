...
var ExportCmd = &cobra.Command{
	Use:   "export",
	Short: "Export data from grommunio-chat",
	Long:  "Export data from grommunio-chat in a format suitable for import into a third-party application or another grommunio-chat instance",
}

var ScheduleExportCmd = &cobra.Command{
	Use:     "schedule",
	Short:   "Schedule an export data job in grommunio-chat",
	Long:    "Schedule an export data job in grommunio-chat (this will run asynchronously via a background worker)",
...
var CsvExportCmd = &cobra.Command{
	Use:     "csv",
	Short:   "Export data from grommunio-chat in CSV format",
	Long:    "Export data from grommunio-chat in CSV format",
...
var ActianceExportCmd = &cobra.Command{
	Use:     "actiance",
	Short:   "Export data from grommunio-chat in Actiance format",
	Long:    "Export data from grommunio-chat in Actiance format",
...
var GlobalRelayZipExportCmd = &cobra.Command{
	...
	Short:   "Export data from grommunio-chat into a zip file containing emails to send to Global Relay for debug and testing purposes only.",
	Long:    "Export data from grommunio-chat into a zip file containing emails to send to Global Relay for debug and testing purposes only. This does not archive any information in Global Relay.",
...
var BulkExportCmd = &cobra.Command{
	...
	Long:    "Export data to a file compatible with the grommunio-chat Bulk Import format.",
