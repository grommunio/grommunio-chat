...
var PluginAddCmd = &cobra.Command{
	Use:     "add [plugins]",
	Short:   "Add plugins",
	Long:    "Add plugins to your grommunio-chat server.",
...
var PluginDeleteCmd = &cobra.Command{
	...
	Long:    "Delete previously uploaded plugins from your grommunio-chat server.",
...
var PluginEnableCmd = &cobra.Command{
	...
	Long:    "Enable plugins for use on your grommunio-chat server.",
...
var PluginListCmd = &cobra.Command{
	Use:     "list",
	Short:   "List plugins",
	Long:    "List all enabled and disabled plugins installed on your grommunio-chat server.",
	Example: `  plugin list`,
