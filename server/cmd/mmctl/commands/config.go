...
var ConfigMigrateCmd = &cobra.Command{
	...
	Long:    "Migrate a file-based configuration to (or from) a database-based configuration. Point the grommunio-chat server at the target configuration to start using it. Note that this command is only available in `--local` mode.",
...
var ConfigSubpathCmd = &cobra.Command{
	...
	Long:  "Update the hard-coded production client asset paths to take into account grommunio-chat running on a subpath. This command needs access to the grommunio-chat assets directory to be able to rewrite the paths.",
...
func init() {
	...
	ConfigSubpathCmd.Flags().StringP("assets-dir", "a", "", "directory of the grommunio-chat assets in the local filesystem")
