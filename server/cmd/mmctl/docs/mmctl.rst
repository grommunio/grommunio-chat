...
grommunio-chat offers workplace messaging across web, PC and phones with archiving, search and integration with your existing systems. Documentation available at https://docs.mattermost.com
...
* `mmctl auth <mmctl_auth.rst>`_ 	 - Manages the credentials of the remote grommunio-chat instances
