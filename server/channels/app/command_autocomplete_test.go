...
func TestSuggestions(t *testing.T) {
	...
	assert.Equal(t, "Connect your grommunio-chat account to your Jira account", suggestions[0].Description)
...
func createJiraAutocompleteData() *model.AutocompleteData {
	...
	connect := model.NewAutocompleteData("connect", "[url]", "Connect your grommunio-chat account to your Jira account")
	jira.AddCommand(connect)

	disconnect := model.NewAutocompleteData("disconnect", "", "Disconnect your grommunio-chat account from your Jira account")
	...
	install := model.NewAutocompleteData("install", "", "Connect grommunio-chat to a Jira instance")
	...
	uninstall := model.NewAutocompleteData("uninstall", "", "Disconnect grommunio-chat from a Jira instance")
