...
func TestCheckClientCompatability(t *testing.T) {
	...
	var uaTestParameters = []uaTest{
		...
		{"MM App 3.7.1", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) grommunio-chat/3.7.1 Chrome/56.0.2924.87 Electron/1.6.11 Safari/537.36", true},
