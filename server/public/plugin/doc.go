...
// The plugin package is used by grommunio-chat server plugins written in go. It also enables the
// grommunio-chat server to manage and interact with the running plugin environment.
//
