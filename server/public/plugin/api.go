...
type API interface {
	...
	// GetLicense returns the current license used by the grommunio-chat server. Returns nil if
	...
	// IsEnterpriseReady returns true if the grommunio-chat server is configured as Enterprise Ready.
	//
	// @tag Server
	// Minimum server version: 5.10
	IsEnterpriseReady() bool

	// GetServerVersion return the current grommunio-chat server version
	//
	// @tag Server
	// Minimum server version: 5.4
	GetServerVersion() string

	// GetSystemInstallDate returns the time that grommunio-chat was first installed and ran.
	//
	// @tag Server
	// Minimum server version: 5.10
	...
	// LogDebug writes a log message to the grommunio-chat server log file.
	...
	// LogInfo writes a log message to the grommunio-chat server log file.
	// Appropriate context such as the plugin name will already be added as fields so plugins
	// do not need to add that info.
	//
	// @tag Logging
	...
	// LogError writes a log message to the grommunio-chat server log file.
	// Appropriate context such as the plugin name will already be added as fields so plugins
	// do not need to add that info.
	//
	// @tag Logging
	...
	// LogWarn writes a log message to the grommunio-chat server log file.
	// Appropriate context such as the plugin name will already be added as fields so plugins
	// do not need to add that info.
	//
	// @tag Logging
