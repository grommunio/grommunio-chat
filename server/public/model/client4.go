...
// LinkLdapGroup creates or undeletes a grommunio-chat group and associates it to the given LDAP group DN.
...
// UnlinkLdapGroup deletes the grommunio-chat group associated with the given LDAP group DN.
...
// GetGroupsByChannel retrieves the grommunio-chat Groups associated with a given channel
...
// GetGroupsByTeam retrieves the grommunio-chat Groups associated with a given team
...
// GetGroupsAssociatedToChannelsByTeam retrieves the grommunio-chat Groups associated with channels in a given team
...
// GetGroups retrieves grommunio-chat Groups
...
// GetGroupsByUserId retrieves grommunio-chat Groups for a user
...
// CreateOAuthApp will register a new OAuth 2.0 client application with grommunio-chat acting as an OAuth 2.0 service provider.
...
// UpdateOAuthApp updates a page of registered OAuth 2.0 client applications with grommunio-chat acting as an OAuth 2.0 service provider.
...
// GetOAuthApps gets a page of registered OAuth 2.0 client applications with grommunio-chat acting as an OAuth 2.0 service provider.
...
// GetOAuthApp gets a registered OAuth 2.0 client application with grommunio-chat acting as an OAuth 2.0 service provider.
...
// GetOAuthAppInfo gets a sanitized version of a registered OAuth 2.0 client application with grommunio-chat acting as an OAuth 2.0 service provider.
...
// GetGroupStats retrieves stats for a grommunio-chat Group
