...
type Manifest struct {
	...
	// The minimum grommunio-chat server version required for your plugin.
	//
	...
	// To allow administrators to configure your plugin via the grommunio-chat system console, you can
