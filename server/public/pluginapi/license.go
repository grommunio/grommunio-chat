...
// IsEnterpriseLicensedOrDevelopment returns true when the server is licensed with any grommunio-chat
...
// IsE10LicensedOrDevelopment returns true when the server is at least licensed with a legacy grommunio-chat
// Enterprise E10 License or a grommunio-chat Professional License, or has `EnableDeveloper` and
...
// IsE20LicensedOrDevelopment returns true when the server is licensed with a legacy grommunio-chat
// Enterprise E20 License or a grommunio-chat Enterprise License, or has `EnableDeveloper` and
// `EnableTesting` configuration settings enabled, signaling a non-production, developer mode.
