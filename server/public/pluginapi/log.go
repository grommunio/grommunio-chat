...
// LogService exposes methods to log to the grommunio-chat server log.
//
// Note that standard error is automatically sent to the grommunio-chat server log, and standard
