...
var I18nCmd = &cobra.Command{
	Use:   "i18n",
	Short: "Management of grommunio-chat translations",
}
...
func init() {
	...
	ExtractCmd.Flags().String("portal-dir", "../customer-web-server", "Path to folder with the grommunio-chat Customer Portal source code")
	ExtractCmd.Flags().String("enterprise-dir", "../../enterprise", "Path to folder with the grommunio-chat enterprise source code")
	ExtractCmd.Flags().String("server-dir", "./", "Path to folder with the grommunio-chat server source code")
	ExtractCmd.Flags().String("model-dir", "../model", "Path to folder with the grommunio-chat model package source code")
	ExtractCmd.Flags().String("plugin-dir", "../plugin", "Path to folder with the grommunio-chat plugin package source code")
	...
	CheckCmd.Flags().String("portal-dir", "../customer-web-server", "Path to folder with the grommunio-chat Customer Portal source code")
	CheckCmd.Flags().String("enterprise-dir", "../../enterprise", "Path to folder with the grommunio-chat enterprise source code")
	CheckCmd.Flags().String("server-dir", "./", "Path to folder with the grommunio-chat server source code")
	CheckCmd.Flags().String("model-dir", "../model", "Path to folder with the grommunio-chat model package source code")
	CheckCmd.Flags().String("plugin-dir", "../plugin", "Path to folder with the grommunio-chat plugin package source code")

	CheckEmptySrcCmd.Flags().String("portal-dir", "../customer-web-server", "Path to folder with the grommunio-chat Customer Portal source code")
	CheckEmptySrcCmd.Flags().String("enterprise-dir", "../../enterprise", "Path to folder with the grommunio-chat enterprise source code")
	CheckEmptySrcCmd.Flags().String("server-dir", "./", "Path to folder with the grommunio-chat server source code")
	...
	CleanEmptyCmd.Flags().String("portal-dir", "../customer-web-server", "Path to folder with the grommunio-chat Customer Portal source code")
	CleanEmptyCmd.Flags().String("enterprise-dir", "../../enterprise", "Path to folder with the grommunio-chat enterprise source code")
	CleanEmptyCmd.Flags().String("server-dir", "./", "Path to folder with the grommunio-chat server source code")
