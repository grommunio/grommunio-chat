...
export const CloudLinks = {
    BILLING_DOCS: 'https://docs.grommunio.com',
    PRICING: 'https://grommunio.com',
    PRORATED_PAYMENT: 'https://grommunio.com',
    DEPLOYMENT_OPTIONS: 'https://grommunio.com',
    DOWNLOAD_UPDATE: 'https://grommunio.com',
    CLOUD_SIGNUP_PAGE: 'https://grommunio.com',
    SELF_HOSTED_SIGNUP: 'https://customers.mattermost.com/signup',
    DELINQUENCY_DOCS: 'https://docs.grommunio.com',
    SELF_HOSTED_PRICING: 'https://grommunio.com',
};

export const HostedCustomerLinks = {
    BILLING_DOCS: 'https://grommunio.com',
    SELF_HOSTED_BILLING: 'https://grommunio.com',
    TERMS_AND_CONDITIONS: 'https://grommunio.com',
    SECURITY_UPDATES: 'https://grommunio.com',
    DOWNLOAD: 'https://grommunio.com',
    NEWSLETTER_UNSUBSCRIBE_LINK: 'https://forms.mattermost.com/UnsubscribePage.html',
    PRIVACY: AboutLinks.PRIVACY_POLICY,
};

export const DocLinks = {
    ABOUT_TEAMS: 'https://docs.grommunio.com',
    ADVANCED_LOGGING: 'https://grommunio.com',
    CONFIGURE_DOCUMENT_CONTENT_SEARCH: 'https://grommunio.com',
    CONFIGURE_AD_LDAP_QUERY_TIMEOUT: 'https://grommunio.com',
    CONFIGURE_OVERRIDE_SAML_BIND_DATA_WITH_LDAP: 'https://grommunio.com',
    COMPILANCE_EXPORT: 'https://grommunio.com',
    COMPILANCE_MONITORING: 'https://grommunio.com',
    DATA_RETENTION_POLICY: 'https://grommunio.com',
    DEFAULT_LDAP_GROUP_SYNC: 'https://grommunio.com',
    DESKTOP_MANAGED_RESOURCES: 'https://grommunio.com',
    ELASTICSEARCH: 'https://grommunio.com',
    ENABLE_CLIENT_SIDE_CERTIFICATION: 'https://grommunio.com',
    ENABLE_HARDENED_MODE: 'https://grommunio.com',
    FORMAT_MESSAGES: 'https://grommunio.com',
    FILE_STORAGE: 'https://grommunio.com',
    GUEST_ACCOUNTS: 'https://docs.grommunio.com',
    HIGH_AVAILABILITY_CLUSTER: 'https://grommunio.com',
    IN_PRODUCT_NOTICES: 'https://grommunio.com',
    MULTI_FACTOR_AUTH: 'https://grommunio.com',
    ONBOARD_ADVANCED_PERMISSIONS: 'https://grommunio.com',
    ONBOARD_LDAP: 'https://grommunio.com',
    SELF_HOSTED_BILLING: HostedCustomerLinks.SELF_HOSTED_BILLING,
    SESSION_LENGTHS: 'https://grommunio.com',
    SETUP_IMAGE_PROXY: 'https://grommunio.com',
    SETUP_LDAP: 'https://grommunio.com',
    SETUP_PERFORMANCE_MONITORING: 'https://grommunio.com',
    SETUP_PUSH_NOTIFICATIONS: 'https://grommunio.com',
    SETUP_SAML: 'https://docs.grommunio.com',
    SHARE_LINKS_TO_MESSAGES: 'https://grommunio.com',
    SITE_URL: 'https://grommunio.com',
    SSL_CERTIFICATE: 'https://grommunio.com',
    TRUE_UP_REVIEW: 'https://grommunio.com',
    TRUSTED_CONNECTION: 'https://grommunio.com',
    UPGRADE_SERVER: 'https://grommunio.com',
};

export const DeveloperLinks = {
    CUSTOM_SLASH_COMMANDS: 'https://grommunio.com',
    ENABLE_OAUTH2: 'https://grommunio.com',
    INCOMING_WEBHOOKS: 'https://grommunio.com',
    OUTGOING_WEBHOOKS: 'https://grommunio.com',
    INTERACTIVE_MESSAGES: 'https://grommunio.com',
    INTERACTIVE_DIALOGS: 'https://grommunio.com',
    PERSONAL_ACCESS_TOKENS: 'https://grommunio.com',
    PLUGIN_SIGNING: 'https://grommunio.com',
    PLUGINS: 'https://grommunio.com',
    SETUP_CUSTOM_SLASH_COMMANDS: 'https://grommunio.com',
    SETUP_INCOMING_WEBHOOKS: 'https://grommunio.com',
    SETUP_OAUTH2: 'https://grommunio.com',
    SETUP_OUTGOING_WEBHOOKS: 'https://grommunio.com',
};

export const LicenseLinks = {
    CONTACT_SALES: 'https://grommunio.com',
    TRIAL_INFO_LINK: 'https://grommunio.com',
    EMBARGOED_COUNTRIES: 'https://grommunio.com',
    SOFTWARE_SERVICES_LICENSE_AGREEMENT: 'https://grommunio.com',
    SOFTWARE_SERVICES_LICENSE_AGREEMENT_TEXT: 'Software Services and License Agreement',
};

export const MattermostLink = 'https://grommunio.com';
