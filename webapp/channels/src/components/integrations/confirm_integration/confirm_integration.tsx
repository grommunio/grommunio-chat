        ...
        helpText = (
            <p>
                <FormattedMessage
                    ...
                    defaultMessage='Your bot account **{botname}** has been created successfully. Please use the following access token to connect to the bot (see [documentation](https://grommunio.com/pl/default-bot-accounts) for further details).'
                    values={{
