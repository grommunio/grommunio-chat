                ...
                <BooleanSetting
                    ...
                    helpText={
                        <FormattedMarkdownMessage
                            ...
                            defaultMessage='When true, new users must accept the terms of service before accessing any grommunio-chat teams on desktop, web or mobile. Existing users must accept them after login or a page refresh.\n \nTo update terms of service link displayed in account creation and login pages, go to [Site Configuration > Customization](../site_config/customization).'
                        />
                    }
