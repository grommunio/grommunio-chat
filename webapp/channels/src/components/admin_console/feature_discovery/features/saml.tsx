...
const SAMLFeatureDiscovery: React.FC = () => {
    return (
        <FeatureDiscovery
            ...
            titleDefault='Integrate SAML 2.0 with grommunio-chat Professional'
            copyID='admin.saml_feature_discovery.copy'
            copyDefault={'When you connect grommunio-chat with your organization\'s single sign-on provider, users can access grommunio-chat without having to re-enter their credentials.'}
