    ...
    <tr>
        ...
        <td>
            <FormattedMessage
                ...
                defaultMessage='grommunio chat will connect over an insecure connection.'
            />
        </td>
    </tr>
);
    ...
    <tr>
        ...
        <td>
            <FormattedMessage
                ...
                defaultMessage='Encrypts the communication between grommunio chat and your server.'
            />
        </td>
    </tr>
);
                ...
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The grommunio chat server will serve static files compressed with gzip.'
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The grommunio chat server will serve static files uncompressed.'
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The grommunio chat server will not serve static files.'
                        />
                    </td>
                </tr>
            </tbody>
