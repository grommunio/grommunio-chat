...
const TrialLicenseCard: React.FC<Props> = ({license}: Props) => {
    ...
    const messageBody = () => {
        if (currentDate.toDateString() === endDate.toDateString()) {
            return (
                <FormattedMessage
                    ...
                    defaultMessage='Your free trial expires <b>Today at {time}</b>. Visit our customer portal to purchase a license now to continue using grommunio chat Professional and Enterprise features after trial ends'
                    values={{
        ...
        return (
            <FormattedMessage
                ...
                defaultMessage='Your free trial will expire in <b>{daysCount} {daysCount, plural, one {day} other {days}}</b>. Visit our customer portal to purchase a license now to continue using grommunio chat Professional and Enterprise features after trial ends.'
                values={{
                    b: (chunks: string) => <b>{chunks}</b>,
    ...
    const cardTitle = (
        <FormattedMessage
            ...
            defaultMessage='You’re currently on a free trial of our grommunio chat Enterprise license.'
        />
    );
    return (
        <AlertBanner
