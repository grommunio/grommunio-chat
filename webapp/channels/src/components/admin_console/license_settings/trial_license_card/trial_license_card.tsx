    ...
    const messageBody = () => {
        if (currentDate.toDateString() === endDate.toDateString()) {
            return (
                <FormattedMarkdownMessage
                    ...
                    defaultMessage='Your free trial expires **Today at {time}**. Visit our customer portal to purchase a license now to continue using grommunio chat Professional and Enterprise features after trial ends'
                    values={{
        ...
        return (
            <FormattedMarkdownMessage
                ...
                defaultMessage='Your free trial will expire in **{daysCount} {daysCount, plural, one {day} other {days}}**. Visit our customer portal to purchase a license now to continue using grommunio chat Professional and Enterprise features after trial ends.'
                values={{
