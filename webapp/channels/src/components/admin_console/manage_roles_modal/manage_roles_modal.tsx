                    ...
                    <div className='checkbox'>
                        <label>
                            ...
                            <FormattedMessage
                                ...
                                defaultMessage='Access to post to all grommunio chat channels including direct messages.'
                            />
                        </label>
                    </div>
                    <div className='checkbox'>
                        <label>
                            ...
                            <FormattedMessage
                                ...
                                defaultMessage='Access to post to all grommunio chat public channels.'
                            />
                        </label>
                    </div>
                </div>
